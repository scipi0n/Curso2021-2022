...
qu = prepareQuery('''SELECT ?entity WHERE    {
...
qu2 = prepareQuery('''SELECT ?entity WHERE    {
    ?s rdfs:subClassOf ns:Person .
    ?entity rdf:type ?s .
}''',
initNs = {"rdfs":RDFS, "rdf":RDF, "ns":ns} )

for s in g.query(qu2):
    print(s)
...
qu3 = prepareQuery('''SELECT ?entity ?property ?object WHERE    {
    ?s rdfs:subClassOf ns:Person .
    ?entity rdf:type ?s .
